...
import { UserAddressResponseDto } from '../dto/user-addresses/response/user-address.response.dto';
...
export class UserAddressesService {
  ...
  async findActiveUserAddressEntityByIdOrThrow(
    ...
    const address =
      await this.userAddressesRepository.findActiveUserAddressById(
        userId,
        addressId,
      );
    if (!address) {
  ...
  async createNewUserAddress(
    ...
    const newUserAddress = await this.userAddressesRepository.createAddress(
      userId,
  ...
  async updateUserAddress(
    ...
    const updatedAddresses =
      await this.userAddressesRepository.updateUserAddress(
        userId,
        addressId,
  ...
  async deleteUserAddressesOrThrow(
    ...
    const deleteResult =
      await this.userAddressesRepository.softDeleteUserAddresses(
        userId,
        addressIds,
      );
